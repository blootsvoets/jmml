 ...
 */ 
public class Category implements Child<Category>, Comparable<Category> {
	...
	private final static Map<Child,Category> categoriesDomain;
	static {
		categoriesDomain = new ArrayMap<Child,Category>();
	 ...
	 */
	public static Category getCategory(Child dom) {
