...
import eu.mapperproject.jmml.util.Tuple;
...
public class MMLDefinitions {
	...
	public MMLDefinitions(Map<String,Datatype> datatypes, Map<String,Converter> converters, Map<String,Submodel> submodels) {
